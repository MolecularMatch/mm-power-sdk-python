...
class ClinicalTrialInterventions(object):
    ...
    def __init__(self, intervention_type='Other', intervention_name=None, description=None, arm_group_label=None, other_name=None):  # noqa: E501
        """ClinicalTrialInterventions - a model defined in Swagger"""  # noqa: E501
    ...
    def intervention_type(self):
        """Gets the intervention_type of this ClinicalTrialInterventions.  # noqa: E501

        For each intervention studied in the clinical study, the general type of intervention.  # noqa: E501

        :return: The intervention_type of this ClinicalTrialInterventions.  # noqa: E501
        :rtype: str
        """
    ...
    def intervention_type(self, intervention_type):
        """Sets the intervention_type of this ClinicalTrialInterventions.

        For each intervention studied in the clinical study, the general type of intervention.  # noqa: E501

        :param intervention_type: The intervention_type of this ClinicalTrialInterventions.  # noqa: E501
        :type: str
        """
    ...
    def intervention_name(self):
        """Gets the intervention_name of this ClinicalTrialInterventions.  # noqa: E501

        A brief descriptive name used to refer to the intervention(s) studied in each arm of the clinical study.  # noqa: E501

        :return: The intervention_name of this ClinicalTrialInterventions.  # noqa: E501
        :rtype: str
        """
    ...
    def intervention_name(self, intervention_name):
        """Sets the intervention_name of this ClinicalTrialInterventions.

        A brief descriptive name used to refer to the intervention(s) studied in each arm of the clinical study.  # noqa: E501

        :param intervention_name: The intervention_name of this ClinicalTrialInterventions.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this ClinicalTrialInterventions.  # noqa: E501
        ...
        :return: The description of this ClinicalTrialInterventions.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ClinicalTrialInterventions.

        Details that can be made public about the intervention, other than the Intervention Name(s) and Other Intervention Name(s), sufficient to distinguish the intervention from other, similar interventions studied in the same or another clinical study. For example, interventions involving drugs may include dosage form, dosage, frequency, and duration.  # noqa: E501

        :param description: The description of this ClinicalTrialInterventions.  # noqa: E501
        :type: str
        """
    ...
    def arm_group_label(self):
        """Gets the arm_group_label of this ClinicalTrialInterventions.  # noqa: E501

        If multiple Arms or Groups have been specified, indicate which Arm Groups this intervention applies to.  # noqa: E501

        :return: The arm_group_label of this ClinicalTrialInterventions.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def arm_group_label(self, arm_group_label):
        """Sets the arm_group_label of this ClinicalTrialInterventions.

        If multiple Arms or Groups have been specified, indicate which Arm Groups this intervention applies to.  # noqa: E501

        :param arm_group_label: The arm_group_label of this ClinicalTrialInterventions.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def other_name(self):
        """Gets the other_name of this ClinicalTrialInterventions.  # noqa: E501


        :return: The other_name of this ClinicalTrialInterventions.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def other_name(self, other_name):
        """Sets the other_name of this ClinicalTrialInterventions.


        :param other_name: The other_name of this ClinicalTrialInterventions.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClinicalTrialInterventions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClinicalTrialInterventions):
            return False
