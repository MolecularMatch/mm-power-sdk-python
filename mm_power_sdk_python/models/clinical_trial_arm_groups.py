...
class ClinicalTrialArmGroups(object):
    ...
    def __init__(self, arm_group_label=None, arm_group_type=None, description=None):  # noqa: E501
        """ClinicalTrialArmGroups - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClinicalTrialArmGroups, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClinicalTrialArmGroups):
            return False
