...
class InstitutionsApi(object):
    ...
    def institution_post(self, **kwargs):  # noqa: E501
        """Create an institution  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.institution_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.institution_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.institution_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def institution_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create an institution  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.institution_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method institution_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def institutions_get(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.institutions_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.institutions_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def institutions_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get a paginated list of institutions  # noqa: E501
