...
**study_design** | [**ClinicalTrialStudyDesign**](ClinicalTrialStudyDesign.md) |  | [optional] 
...
**arm_groups** | [**list[ClinicalTrialArmGroups]**](ClinicalTrialArmGroups.md) | Pre-specified groups of participants in a clinical trial assigned to receive specific interventions (or no intervention) according to a protocol. | [optional] 
